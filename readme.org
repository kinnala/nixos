...
Emacs configuration and determine which addon packages should be automatically
installed from MELPA.

** config/emacs/init.el

The rest of the snippets are combined into the file
=/etc/nixos/config/emacs/init.el=. This file I have symlinked to
=~/.config/emacs/init.el= so that Emacs running under non-root user will find
it.
...
(use-package org
  ...
  (setq org-todo-keyword-faces
        '(("TODO" . org-todo)
          ("NEXT" . (:foreground "yellow4" :background "yellow1" :weight bold))
          ("DONE" . org-done)))
...
;; fonts
(set-face-attribute 'mode-line-inactive nil :font "Source Code Pro-9")
(set-face-attribute 'default nil :font "Source Code Pro-13")
(set-face-attribute 'mode-line nil :font "Source Code Pro-9")
